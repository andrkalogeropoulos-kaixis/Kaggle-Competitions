...
🛠️ Technical Approach & Feature Engineering
    ...
    Feature Construction: * TotalBath: Combined full and half bathrooms into a single metric.
...
🛠️ Technical Approach & Feature Engineering
    ...
    Advanced Feature Engineering: * Created complex mathematical interactions (e.g., Tyre_vs_Lap, Degr_vs_Time) utilizing cube roots to smooth heavily skewed distributions.

        Outlier management using np.clip on highly volatile degradation and delta metrics.

    Unsupervised Learning (K-Means Clustering): * Scaled core racing metrics using StandardScaler and trained a K-Means algorithm (5 clusters) on features like TyreLife and LapNumber.
